package com.example.apiuseramt.security.jwt;
...
public class UserAuthTokenFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private UserAuthService adminAuthService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            logger.error("Cannot set contributor authentication", e);
        }
    ...
    private String parseJwt(HttpServletRequest request) {
        ...
        if (StringUtils.hasText(headerAuth) && headerAuth.startsWith("Bearer ")) {
            result = headerAuth.substring(7, headerAuth.length());
        }
